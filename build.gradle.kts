...
intellijPlatform {
    pluginConfiguration {
        ...
        changeNotes = """
            <ul>
                <li><b>2.4.0</b> — Anonymous usage telemetry (opt-in): Settings → Analytics checkbox sends tool call counts to a Vercel/Postgres backend. Settings page now has a "Ma session / Tous les utilisateurs" toggle with ↺ Refresh to view aggregated stats across all users.</li>
